  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="mx-4 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <h2 className="text-lg font-bold text-slate-800">ワークスペースを作成</h2>
        <p className="mt-1 text-sm text-slate-500">チームのチャットスペースを新しく作ります</p>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">ワークスペース名</label>
            <input
              type="text"
              value={name}
